...
class ClassViewSet(AuditMixin, viewsets.ModelViewSet):
    """ViewSet for Class model."""

    audit_resource_type = ResourceType.CLASS
    ...
    def enroll(self, request, pk=None):
        ...
        TenantAuditService.log(
            ...
            resource_type=ResourceType.ENROLLMENT,
...
class EnrollmentViewSet(AuditMixin, viewsets.ModelViewSet):
    ...
    audit_resource_type = ResourceType.ENROLLMENT
    required_tenant_module = 'classes'
    ...
    def perform_destroy(self, instance):
        ...
        class_id = str(instance.class_obj_id)
        ...
        if self.audit_resource_type:
            try:
                ...
                import logging
                logging.getLogger(__name__).exception('EnrollmentViewSet.perform_destroy audit log failed')
