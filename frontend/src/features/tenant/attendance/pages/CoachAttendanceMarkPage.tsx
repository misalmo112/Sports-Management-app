/**
 * Coach Attendance Mark Page
 * Mark attendance for a class/session (coach version)
 */
...
export const CoachAttendanceMarkPage = () => {
  ...
  // Fetch active classes (already filtered by coach on backend)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        navigate('/dashboard/coach/attendance');
      }, 2000);
    } catch (error: any) {
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="mb-6">
        <Button variant="ghost" onClick={() => navigate('/dashboard/coach/attendance')}>
          ← Back to Attendance
        </Button>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                {formErrors.class_id && (
                  <p className="text-sm text-destructive">{formErrors.class_id[0]}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                {formErrors.date && (
                  <p className="text-sm text-destructive">{formErrors.date[0]}</p>
                )}
              </div>
            </div>
            ...
            <div className="flex justify-end gap-4">
              <Button
                type="button"
                variant="outline"
                onClick={() => navigate('/dashboard/coach/attendance')}
                disabled={markAttendance.isPending}
              >
                Cancel
              </Button>
