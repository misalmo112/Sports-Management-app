 ...
 * Handles multi-file upload with progress tracking and error handling
 */
...
export const MediaUploadModal = ({
  ...
  const canUpload = files.length > 0 && pendingCount > 0 && !uploadMedia.isPending;
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Select one or more files to upload. You can add a description that
