/**
 * Parent Media Page
 * View media for parent's children
 */
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-2">Media for your children</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Media files for your children</CardDescription>
        </CardHeader>
        <CardContent>
          {/* Search */}
          <div className="mb-4">
          ...
          {isLoading ? (
            ...
            <EmptyState
              ...
              description="No media files are available for your children."
            />
          )}
        </CardContent>
      </Card>
