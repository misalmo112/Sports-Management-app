...
import Step2Locations from '../components/steps/Step2Locations';
import { useSaveLocations } from '../hooks/useSaveLocations';
import type { Step2Locations as Step2LocationsType } from '../types';
...
export const LocationsPage = () => {
  ...
  const handleSubmit = async (data: Step2LocationsType) => {
    setErrors({});
    setSuccess(false);

    try {
      await saveLocations.mutateAsync(data);
      setSuccess(true);
