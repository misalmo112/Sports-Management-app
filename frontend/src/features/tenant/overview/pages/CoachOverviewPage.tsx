...
export const CoachOverviewPage = () => {
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="mb-6">
        <h1 className="text-3xl font-bold">Coach Overview</h1>
        <p className="text-muted-foreground mt-2">Your coaching dashboard</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Your classes and coaching statistics</CardDescription>
        </CardHeader>
        <CardContent>
